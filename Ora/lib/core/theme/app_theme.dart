...
class AppTheme {
  static ThemeData light() {
    const base = Color(0xFFF5F7FB);
    const surface = Color(0xFFFFFFFF);
    const surfaceAlt = Color(0xFFE7ECF4);
    const accent = Color(0xFF2563EB);
    const secondary = Color(0xFF5B7CFA);
    ...
    final scheme = const ColorScheme.light().copyWith(
      ...
      outline: const Color(0xFFD0D6E2),
    );
    ...
    return ThemeData(
      ...
      bottomNavigationBarTheme: BottomNavigationBarThemeData(
        ...
        unselectedItemColor: const Color(0xFF5F6B7A),
      ...
      inputDecorationTheme: InputDecorationTheme(
        filled: true,
        fillColor: surfaceAlt.withOpacity(0.7),
